...
class FaceFeature(Feature):
    ...
    def __init__(self, weight=1.0):
        ...
        ands save it at USER_HOME/.katna-main directory, or /tmp/.katna-main directory.\
        ...
        try:
            self.network_folder_path = os.path.join(os.path.expanduser("~"), ".katna-main")
            if not os.access(self.network_folder_path, os.W_OK):
                self.network_folder_path = os.path.join("/tmp", ".katna-main")
